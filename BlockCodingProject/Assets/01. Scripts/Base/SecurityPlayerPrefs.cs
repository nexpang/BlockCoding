...
public class SecurityPlayerPrefs
{
    ...
    {
        // 8 바이트로 하고, 변경해서 쓸것
        byte[] saltBytes = new byte[] { 22, 15, 7, 34, 27, 18, 24, 11 };

        // 길이 상관 없고, 키를 만들기 위한 용도로 씀
        string randomSeedForKey = "7ae8917efc78d1007996eaab78b";

        // 길이 상관 없고, aes에 쓸 key 와 iv 를 만들 용도
        string randomSeedForValue = "8a67e878f9b98a9e9c9b9f78a9b718";
